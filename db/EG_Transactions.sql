USE [master]
GO
/****** Object:  Database [EG_Transactions]    Script Date: 2024/03/11 12:35:10 ******/
CREATE DATABASE [EG_Transactions]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EG_Transactions', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\EG_Transactions.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'EG_Transactions_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\EG_Transactions_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [EG_Transactions]
GO
/****** Object:  Table [dbo].[Client]    Script Date: 2024/03/11 12:35:10 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Transaction]    Script Date: 2024/03/11 12:35:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TransactionType]    Script Date: 2024/03/11 12:35:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SPCreateTransaction]    Script Date: 2024/03/11 12:35:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SPDeleteClientAndTransactions]    Script Date: 2024/03/11 12:35:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SPGetTransactionsForClient]    Script Date: 2024/03/11 12:35:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
